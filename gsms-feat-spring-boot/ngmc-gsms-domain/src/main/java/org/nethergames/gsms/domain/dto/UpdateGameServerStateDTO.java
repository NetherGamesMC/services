...
@Schema(description = "DTO for updating an existing game server state")
public class UpdateGameServerStateDTO extends CreateGameServerStateDTO implements IVersionable {
