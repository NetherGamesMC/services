...
public class GameServerCommandController {

	private static final Logger log = LoggerFactory.getLogger(GameServerCommandController.class);

	private final GameServerCommandService commandService;

	public GameServerCommandController(GameServerCommandService commandService) {
